...
public abstract class MainTabWindow_PawnKindTable : MainTabWindow
{
    ...
    public override Vector2 RequestedTabSize
    {
        get
        {
            ...
            return new Vector2(
                table.Size.x + Margin * 2f, table.Size.y + ExtraBottomSpace + ExtraTopSpace + Margin * 2f
            );
        }
    }
    ...
    {
        return (PawnKindTable)Activator.CreateInstance(
            PawnKindTableDef.workerClass, PawnKindTableDef, (Func<IEnumerable<PawnKindDef>>)(() => PawnKindDefs),
