...
public class PokeWorldMod : Mod
{
    ...
    public override void DoSettingsWindowContents(Rect inRect)
    {
        ...
        listingStandard.CheckboxLabeled(
            "PW_SettingsAllowPokemonInfestation".Translate(), ref PokeWorldSettings.allowPokemonInfestation
        );
        listingStandard.CheckboxLabeled(
            "PW_SettingsAllowNPCPokemonPack".Translate(), ref PokeWorldSettings.allowNPCPokemonPack
        );
        listingStandard.CheckboxLabeled(
            "PW_SettingsEnableShinyMote".Translate(), ref PokeWorldSettings.enableShinyMote
        );
