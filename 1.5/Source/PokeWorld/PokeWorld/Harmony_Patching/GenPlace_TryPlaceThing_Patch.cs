...
namespace PokeWorld
{
    [HarmonyPatch(typeof(GenPlace), nameof(GenPlace.TryPlaceThing), new Type[] { typeof(Thing), typeof(IntVec3), typeof(Map), typeof(ThingPlaceMode), typeof(Action<Thing, int>), typeof(Predicate<IntVec3>), typeof(Rot4) })]
    class GenPlace_TryPlaceThing_Patch
    {
        public static bool Prefix(Thing __0, IntVec3 __1, Map __2, ref bool __result)
        {
            if (__0.def == DefDatabase<ThingDef>.GetNamed("PW_Porygon"))
            {
                ...
                PokemonGeneratorUtility.GenerateAndSpawnNewPokemon(DefDatabase<PawnKindDef>.GetNamed("PW_Porygon"), Faction.OfPlayer, __1, __2, null, true, false);
