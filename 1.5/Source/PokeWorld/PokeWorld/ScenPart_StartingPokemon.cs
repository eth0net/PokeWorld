...
namespace PokeWorld
{
        ...
        private static readonly List<Pair<int, float>> PetCountChances = new List<Pair<int, float>>
    {
        ...
        public override void DoEditInterface(Listing_ScenEdit listing)
        {
            ...
            {
                new FloatMenuOption("RandomPet".Translate().CapitalizeFirst(), delegate
                {
                    animalKind = null;
                })
            };
        ...
        {
            if (other is ScenPart_StartingPokemon scenPart_StartingPokemon && scenPart_StartingPokemon.animalKind == animalKind)
            {
        ...
        public override IEnumerable<Thing> PlayerStartingThings()
        {
            ...
            {
                PawnKindDef kindDef = animalKind ?? RandomPets().RandomElementByWeight((PawnKindDef td) => td.RaceProps.petness);
