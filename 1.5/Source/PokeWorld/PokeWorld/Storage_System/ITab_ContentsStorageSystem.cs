...
internal class ITab_ContentsStorageSystem : ITab
{
    ...
    public override void FillTab()
    {
        ...
        var storageSystem = Find.World.GetComponent<StorageSystem>();
        string header = "PW_StorageSystemContainedPokemon".Translate(storageSystem.GetDirectlyHeldThings().Count,
            storageSystem.maxCount);
    ...
    private void DrawThingRow(ref float y, float width, Thing thing, bool inventory = false)
    {
        ...
        if (Widgets.ButtonImage(rect2, ContentFinder<Texture2D>.Get("UI/Buttons/Drop"), color, mouseoverColor,
                flagPower) && flagPower)
        {
