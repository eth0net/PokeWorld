...
public class JobDriver_CarryToPortableComputer : JobDriver
{
    ...
    private readonly StorageSystem storageSystem = Find.World.GetComponent<StorageSystem>();
    ...
    protected override IEnumerable<Toil> MakeNewToils()
    {
        ...
        this.FailOnThingMissingDesignation(
            TargetIndex.A, DefDatabase<DesignationDef>.GetNamed("PW_PutInPortableComputer")
        );
        ...
        yield return Toils_Goto.GotoThing(TargetIndex.B, PathEndMode.InteractionCell)
            .FailOn(() => !DropPod.TryGetComp<CompPowerTrader>().PowerOn);
        var toil = Toils_General.Wait(100, TargetIndex.B);
        ...
        yield return toil;
        var toil2 = new Toil();
        toil2.initAction = delegate { storageSystem.TryAcceptThing(Takee); };
