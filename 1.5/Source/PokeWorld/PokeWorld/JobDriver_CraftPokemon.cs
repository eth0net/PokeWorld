...
internal class JobDriver_CraftPokemon : JobDriver
{
    ...
    protected override IEnumerable<Toil> MakeNewToils()
    {
        ...
        foreach (var item in CollectIngredientsToils(TargetIndex.B, TargetIndex.A, TargetIndex.C))
            yield return item;
        ...
        bool failIfStackCountLessThanJobCount = true)
    {
        ...
        yield return Toils_Haul.StartCarryThing(ingredientInd, true, subtractNumTakenFromJobCount,
        ...
        var findPlaceTarget =
            Toils_JobTransforms.SetTargetToIngredientPlaceCell(billGiverInd, ingredientInd, ingredientPlaceCellInd);
        yield return findPlaceTarget;
        yield return
            Toils_RecipeCraftPokemon.PlaceHauledThingInCell(ingredientPlaceCellInd, findPlaceTarget, false);
    ...
    public static Toil JumpToCollectNextIntoHandsForBill(Toil gotoGetTargetToil, TargetIndex ind)
    {
        ...
        toil.initAction = delegate
        {
            ...
            {
                Log.Error(string.Concat("JumpToAlsoCollectTargetInQueue run on ", actor,
