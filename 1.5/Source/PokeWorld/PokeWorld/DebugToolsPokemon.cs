...
namespace PokeWorld
{
    ...
    {
        [DebugAction("PokéWorld", "+1 level", actionType = DebugActionType.ToolMap,
        ...
        [DebugAction("PokéWorld", "Max level", actionType = DebugActionType.ToolMap,
            allowedGameStates = AllowedGameStates.PlayingOnMap)]
        ...
        [DebugAction("PokéWorld", "+ 20.000 Xp", actionType = DebugActionType.ToolMap,
            allowedGameStates = AllowedGameStates.PlayingOnMap)]
        ...
        [DebugAction("PokéWorld", "Make Shiny", actionType = DebugActionType.ToolMap,
            allowedGameStates = AllowedGameStates.PlayingOnMap)]
        ...
        [DebugAction("PokéWorld", "+ 20 friendship", actionType = DebugActionType.ToolMap,
            allowedGameStates = AllowedGameStates.PlayingOnMap)]
        ...
        [DebugAction("PokéWorld", "Hatch Pokémon Egg", actionType = DebugActionType.ToolMap,
            allowedGameStates = AllowedGameStates.PlayingOnMap)]
        ...
        [DebugAction("PokéWorld", "Fill Pokédex", actionType = DebugActionType.Action,
        ...
        [DebugAction("PokéWorld", "Fill Pokédex no legendary", actionType = DebugActionType.Action,
            allowedGameStates = AllowedGameStates.Playing)]
        ...
        [DebugAction("PokéWorld", "Show hidden stats", actionType = DebugActionType.ToolMap,
            allowedGameStates = AllowedGameStates.PlayingOnMap)]
        ...
        [DebugAction("PokéWorld", "Make colony (Gen 1)",
            allowedGameStates = AllowedGameStates.PlayingOnMap)]
        ...
        [DebugAction("PokéWorld", "Make colony (Gen 2)",
            allowedGameStates = AllowedGameStates.PlayingOnMap)]
        ...
        [DebugAction("PokéWorld", "Make colony (Gen 3)",
            allowedGameStates = AllowedGameStates.PlayingOnMap)]
        ...
        [DebugAction("PokéWorld", "Make colony (Gen 4)",
            allowedGameStates = AllowedGameStates.PlayingOnMap)]
        ...
        [DebugAction("PokéWorld", "Make colony (Gen 5)",
            allowedGameStates = AllowedGameStates.PlayingOnMap)]
        ...
        [DebugAction("PokéWorld", "Make colony (Gen 6)",
            allowedGameStates = AllowedGameStates.PlayingOnMap)]
        ...
        [DebugAction("PokéWorld", "Make colony (Gen 7)",
            allowedGameStates = AllowedGameStates.PlayingOnMap)]
        ...
        [DebugAction("PokéWorld", "Make colony (Gen 8)",
            allowedGameStates = AllowedGameStates.PlayingOnMap)]
        ...
        [DebugAction("PokéWorld", "Make colony (All Pokémon)",
            allowedGameStates = AllowedGameStates.PlayingOnMap)]
    ...
    public static class Autotests_PokemonColonyMaker
    {
        ...
        public static void MakeColony(int generation)
        {
            ...
            foreach (var item in DefDatabase<PawnKindDef>.AllDefs.Where(k =>
                         k.RaceProps.Animal && k.race.HasComp(typeof(CompPokemon)) &&
