...
namespace PokeWorld
{
    ...
    public static class MoveCardUtility
    {
        ...
        [TweakValue("Interface", -100f, 300f)] private static readonly float PokemonMoveLeft = 220f;

        [TweakValue("Interface", -100f, 300f)] private static readonly float PokemonMoveTop = 0f;
        ...
        private static readonly Texture2D
            LearnedNotTrainingTex = ContentFinder<Texture2D>.Get("UI/Icons/FixedCheckOff");
        ...
        public static void DrawMoveCard(Rect rect, Pawn pawn)
        {
            ...
            listing_Standard.Label(
                "PW_TabMovesPokemonLevel".Translate(pawn.Label, pawn.TryGetComp<CompPokemon>().levelTracker.level),
                22f);
            listing_Standard.Label(
                "PW_TabMovesPokemonExperience".Translate(pawn.Label,
                    pawn.TryGetComp<CompPokemon>().levelTracker.experience,
                    pawn.TryGetComp<CompPokemon>().levelTracker.totalExpForNextLevel), 22f);
            /*
        ...
        private static void DoPokemonMoveTooltip(Rect rect, Pawn pawn, KeyValuePair<MoveDef, int> kvp)
        {
            ...
            TooltipHandler.TipRegion(rect, delegate
            {
                ...
                if (md.tool != null)
                    ...
                    text += "\n\n" +
                            "PW_PowerRangedMove".Translate(md.verb.defaultProjectile.projectile.GetDamageAmount(1),
                                md.verb.range);
