...
namespace PokeWorld
{
	public class BattleLogEntry_PokemonRangedMoveImpact : LogEntry_DamageResult
	{
		...
		public BattleLogEntry_PokemonRangedMoveImpact(Thing initiator, Thing recipient, Thing originalTarget, MoveDef moveDef, ThingDef projectileDef, ThingDef coverDef)
		{
		...
		public override bool ShowInCompactView()
		{
			...
			int num = 1;
			if (moveDef != null && moveDef.verb != null)
			{
				num = moveDef.verb.burstShotCount;
			}
