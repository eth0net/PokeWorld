...
public class PokemonMoveProjectile : Projectile
{
    ...
    public override void Impact(Thing hitThing, bool blockedByShield = false)
    {
        ...
        var battleLogEntry_RangedImpact = new BattleLogEntry_PokemonRangedMoveImpact(launcher, hitThing,
            intendedTarget.Thing, moveDef, def, targetCoverDef);
        Find.BattleLog.Add(battleLogEntry_RangedImpact);
        NotifyImpact(hitThing, map, position);
        if (hitThing != null)
        {
            var dinfo = new DamageInfo(def.projectile.damageDef, base.DamageAmount, base.ArmorPenetration,
