...
internal class Verb_LaunchPokeball : Verb_CastBase
{
    ...
    protected override bool TryCastShot()
    {
        ...
        if (!Rand.Chance(shotReport.AimOnTargetChance_IgnoringPosture))
        {
            ...
            projectile2.Launch(launcher, drawPos, resultingLine.Dest, currentTarget, projectileHitFlags2, equipment,
                targetCoverDef);
            return true;
        }
        ...
        {
            projectile2.Launch(launcher, drawPos, resultingLine.Dest, currentTarget, projectileHitFlags4, equipment,
                targetCoverDef);
            ThrowDebugText("Hit\nDest", resultingLine.Dest);
        }
