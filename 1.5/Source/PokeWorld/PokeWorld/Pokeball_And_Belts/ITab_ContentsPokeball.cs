...
namespace PokeWorld
{
    internal class ITab_ContentsPokeball : ITab
    {
        ...
        protected virtual void DoItemsLists(Rect inRect, ref float curY)
        {
            ...
            for (var i = 0; i < container.Count; i++)
            {
                ...
                if (t != null)
                {
                    ...
                    DoThingRow(t.def, t.stackCount, tmpSingleThing, inRect.width, ref curY,
                        delegate(int x) { OnDropThing(t, x); });
                    tmpSingleThing.Clear();
                }
            }
        ...
        protected void DoThingRow(ThingDef thingDef, int count, List<Thing> things, float width, ref float curY,
