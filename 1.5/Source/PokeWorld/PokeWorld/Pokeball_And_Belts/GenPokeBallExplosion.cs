...
public static class GenPokeBallExplosion
{
    ...
    public static void DoExplosion(IntVec3 center, Map map, float radius, DamageDef damType, Thing instigator,
        float bonusBall, int damAmount = -1, float armorPenetration = -1f, SoundDef explosionSound = null,
        ...
        int preExplosionSpawnThingCount = 1, float chanceToStartFire = 0f, bool damageFalloff = false,
        float? direction = null, List<Thing> ignoredThings = null)
    {
        ...
        var obj = (PokeBallExplosion)GenSpawn.Spawn(DefDatabase<ThingDef>.GetNamed("PW_PokeBallExplosion"), center,
            map);
    ...
    private static void CalculateNeededLOSToCells(IntVec3 position, Map map, float direction,
        out IntVec3? needLOSToCell1, out IntVec3? needLOSToCell2)
    {
        needLOSToCell1 = null;
        needLOSToCell2 = null;
