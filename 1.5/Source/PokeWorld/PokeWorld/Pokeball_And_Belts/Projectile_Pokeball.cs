...
namespace PokeWorld
{
    public class Projectile_Pokeball : Projectile
    {
        ...
        public void Launch(Thing launcher, LocalTargetInfo usedTarget, LocalTargetInfo intendedTarget,
            ProjectileHitFlags hitFlags, Thing equipment = null)
        {
            Launch(launcher, Position.ToVector3Shifted(), usedTarget, intendedTarget, hitFlags, equipment);
        }

        public void Launch(Thing launcher, Vector3 origin, LocalTargetInfo usedTarget, LocalTargetInfo intendedTarget,
        ...
        protected virtual void Explode()
        {
            ...
            GenPokeBallExplosion.DoExplosion(Position, map, def.projectile.explosionRadius, def.projectile.damageDef,
                launcher, bonusBall, base.DamageAmount, base.ArmorPenetration, def.projectile.soundExplode,
                equipmentDef, def, intendedTarget.Thing, def.projectile.postExplosionSpawnThingDef,
                def.projectile.postExplosionSpawnChance, def.projectile.postExplosionSpawnThingCount,
